# Generated by Powerlevel10k configuration wizard on 2021-04-21 at 00:00 MDT.
...
() {
  ...
  # If you see garbled/duplicate prompts in new iTerm tabs (race with async segments), try =off.
